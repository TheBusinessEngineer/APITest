...
# Edit
stub_request(:post, "https://#{$userlogin}:#{$userpass}@api.github.com/teams/123456").
...
# invalid fields
stub_request(:post, "https://#{$userlogin}:#{$userpass}@api.github.com/orgs/CognitiveTest/teams").with(:body => {"name" => "TeamCogScale", "test" => "test", "permission" => "dsa", "repo_names" => [ "junutula/Cognitive" ]}, :headers => {:content_type => 'application/json'}).
